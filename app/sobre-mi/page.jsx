      ...
      <div className="container mx-aut px-0">
        <div className="flex flex-col xl:flex-row items-center gap-24 w-full h-[680px]">
          ...
          <div className="hidden xl:flex flex-col w-full h-full pt-14 max-w-[430px] relative">
            ...
            {/* blob + socials */}
            <div className="absolute top-20 -left-20 w-[420px] h-[420px] z-20 flex items-center justify-center">
              <Blob2 containerStyles="w-full h-full" />

              <Socials
                containerStyles="absolute z-40 flex gap-4"
